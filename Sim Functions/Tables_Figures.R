...
####### Make figures ######
make_figures <- function(results, title, fire_sim_flag=FALSE){
...
# 
# trace_fire_noIntervention <- as.data.frame(sim_fire$TR_absolute)
# trace_fire_noIntervention$cycle <- factor(0:n_t)
